          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                RichText(
                  ...
                  text: TextSpan(
                      ...
                      children: [
                        ...
                        TextSpan(text: "\nor",style: TextStyle(color: Color.fromRGBO(104, 104, 104, 1),
                          fontSize: Utils(context).getMediaWidth() * 0.06,
                          fontWeight: FontWeight.w500,
                        ),),
                        TextSpan(text: "\nEmail for Login"),
                ...
                Text("You will get a OTP via SMS or Email",style: TextStyle(color: Color.fromRGBO(104, 104, 104, 1),
                ...
                RegisterInputField(
                    controller: nameController, labelName: "Mobile No./Email", formkey: _formKey,),
                SizedBox(
                  height: Utils(context).getMediaHeight() * 0.06,
                ),
                InkWell(
