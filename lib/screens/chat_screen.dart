...
class _ChatScreenState extends State<ChatScreen> {
  ...
  void dispose() {
    timer?.cancel();
    checkUserStatus("Offline");
    super.dispose();
  }

  checkUserStatus(String status) async {
    CheckUserStatusResponse _checkUserStatusResponse = await Plugs(context)
        .checkUserStatus(Userid: userDetails.id.toString(), status: status);
    setState(() {
      checkUserStatusResponse = _checkUserStatusResponse;
    });
  }
              ...
              child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return Container(
                      ...
                      child: Row(
                        mainAxisAlignment: getMsgResponse.data[index].toId
                            .toString() == userDetails.id.toString()
                            ? MainAxisAlignment.start
                            : MainAxisAlignment.end,
                        children: [
                          getMsgResponse.data[index].toId.toString() ==
                          ...
                          getMsgResponse.data[index].toId.toString() ==
                            ...
                            padding: EdgeInsets.only(
                              ...
                              : Container(),
                          Column(
                            crossAxisAlignment: getMsgResponse.data[index].toId
                                .toString() == userDetails.id.toString()
                            ...
                            children: [
                              Container(
                                  decoration: BoxDecoration(
                                      color: getMsgResponse.data[index].toId
                                          .toString() ==
                                          userDetails.id.toString()
                                          ? Colors.purpleAccent
                                      ...
                                      borderRadius: BorderRadius.only(
                                          ...
                                          bottomLeft: getMsgResponse.data[index]
                                              .toId.toString() ==
                                              userDetails.id.toString()
                                              ? Radius.circular(0)
                                              : Radius.circular(10),
                                          bottomRight: getMsgResponse
                              ...
                              Text(
                                "${DateFormat().format(DateTime.parse(
                                    getMsgResponse.data[index].createdAt))}",
                                style: TextStyle(
                                    color: Colors.grey,
                                    fontSize:
                                    Utils(context).getMediaHeight() *
                        ...
                        children: [
                          ...
                          getMsgResponse.data[index].toId == userDetails.id
                            ...
                            padding: EdgeInsets.only(
                              ...
                              : Container(),
                          Column(
                            crossAxisAlignment: getMsgResponse.data[index]
                                .toId == userDetails.id
                                ? CrossAxisAlignment.start
                                : CrossAxisAlignment.end,
                            children: [
  ...
  sendMsg() async {
    try {
      ...
      await Plugs(context).sendMsg(
          to_id: partnerData.id.toString(), MSG: msgController.text);
      setState(() {
        msgController.text = "";
      });
      fetch();
